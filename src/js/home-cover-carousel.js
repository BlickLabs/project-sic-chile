...
.on('changed.owl.carousel', function(event) {
  console.log(event.item.index);
   if (window.location.pathname === '/index.html' || window.location.pathname === '/' || window.location.pathname === '/project-sic-chile/index.html' || window.location.pathname === '/project-sic-chile/') {
   ...
   if (window.location.pathname === '/index-en.html' || window.location.pathname === '/project-sic-chile/index-en.html') {
    if (event.item.index === 0 || event.item.index === 3) {
      typed1En();
     } else if (event.item.index === 4) {
      typed2En();
