...
function doSomething(scroll_pos) {
  if (window.location.pathname === '/index.html' || window.location.pathname === '/index-en.html' || window.location.pathname === '/' || window.location.pathname === '/project-sic-chile/index.html' || window.location.pathname === '/project-sic-chile/index-en.html' || window.location.pathname === '/project-sic-chile/') {
    if (scroll_pos > 30) {
